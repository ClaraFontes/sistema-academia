...
public class CreateController {
	...
	public static Aluno createAluno(String user, String password, String nome, String sexo, String cpf, String telefone, String email, String data_nascimento, Double altura, Double peso, Double bf, String comorbidade) throws ClassNotFoundException, SQLException {
		...
		else if(nome.matches("^[0-9]*[.]{0,1}[0-9]*$") || sexo.matches("^[0-9]*[.]{0,1}[0-9]*$") || comorbidade.matches("^[0-9]*[.]{0,1}[0-9]*$") || cpf.matches("^[a-zA-ZÁÂÃÀÇÉÊÍÓÔÕÚÜáâãàçéêíóôõúü]*$") || altura.toString().matches("^[a-zA-ZÁÂÃÀÇÉÊÍÓÔÕÚÜáâãàçéêíóôõúü]*$") || peso.toString().matches("^[a-zA-ZÁÂÃÀÇÉÊÍÓÔÕÚÜáâãàçéêíóôõúü]*$") || bf.toString().matches("^[a-zA-ZÁÂÃÀÇÉÊÍÓÔÕÚÜáâãàçéêíóôõúü]*$")) {
	...
	public static Professor createProfessor(String user, String password, String nome, String telefone, String email, String cref) throws ClassNotFoundException, SQLException {
